...
if monte == "classique":
  # Parameters for Monte Carlo simulation
    ...
    data = yf.download(ticker, start="1900-01-01", end=datetime.today().strftime('%Y/%m/%d'))  #py.get_stock_historical_data(stock=ticker, country='United states', from_date='01/01/2021', to_date='31/12/2021')
